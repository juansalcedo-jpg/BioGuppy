  ...
  <div class="row justify-content-center">
    <div class="col-xl-11">
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-between mb-4 gap-2">
        <div>
          <h4 class="fw-bold text-dark mb-1">Historial de Actividades — Zoocriadero</h4>
      ...
      <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
          ...
          <form id="formFiltroHistorial" action="index.php" method="GET">
            ...
            <div class="row g-3 align-items-end">
              ...
              <div class="col-12 col-md-3">
                <label for="selectZoocriadero" class="form-label text-dark fw-bold small mb-1">Zoocriadero</label>
                <div class="input-group input-group-sm rounded-3 overflow-hidden border bg-white shadow-xs">
                  <select id="selectZoocriadero" name="codzoocriadero" class="form-select border-0 bg-transparent py-2 shadow-none">
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0" id="tablaHistorialZoo">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="py-3 fw-semibold text-dark"><?php echo htmlspecialchars($act['tipo_actividad']); ?></td>
                <td class="py-3">
                  <span class="text-dark fw-medium"><?php echo htmlspecialchars($act['tanque']); ?></span>
                  <span class="text-muted small"> · <?php echo htmlspecialchars($act['zoocriadero']); ?></span>
                </td>
                <td class="py-3 text-muted"><?php echo htmlspecialchars($act['responsable']); ?></td>
                <td class="py-3 text-muted small" style="max-width: 200px;"><?php echo htmlspecialchars($act['observaciones'] ?? '—'); ?></td>
