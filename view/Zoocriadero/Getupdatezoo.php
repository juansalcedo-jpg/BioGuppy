        ...
        <form action="<?php echo getUrl('Zoocriadero', 'Zoocriadero', 'postUpdateZoo'); ?>" method="post" novalidate>
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="codbarrio" name="codbarrio" required>
                        ...
                        ?>
                            <option value="<?php echo htmlspecialchars($barrio['codbarrio']); ?>" data-comuna="<?php echo htmlspecialchars($barrio['codcomuna']); ?>" <?php if ($barrioSeleccionado) { echo 'selected'; } ?> <?php if (!$mismaComuna) { echo 'hidden disabled'; } ?>>
