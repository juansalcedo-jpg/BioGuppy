        ...
        <form action="<?php echo getUrl('Zoocriadero', 'Zoocriadero', 'postCreateZoo'); ?>" method="post" novalidate>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" maxlength="80" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ ]+" title="Solo letras y espacios (sin números ni símbolos)" placeholder="Ej: Zoocriadero Terrón Colorado" required>
                </div>

                <div class="col-md-6">
                    <label for="direccion" class="form-label fw-semibold">Dirección del Zoocriadero *</label>
                    <input type="text" class="form-control" id="direccion" name="direccion" pattern="^(Calle|Carrera|Avenida)\b.*" title="Debe iniciar con Calle, Carrera o Avenida" placeholder="Ej: Carrera 8 # 3-15" required>
                </div>
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="codcomuna" name="codcomuna" required>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="codbarrio" name="codbarrio" required disabled>
                        ...
                        ?>
                            <option value="<?php echo htmlspecialchars($barrio['codbarrio']); ?>" data-comuna="<?php echo htmlspecialchars($barrio['codcomuna']); ?>" hidden disabled>
