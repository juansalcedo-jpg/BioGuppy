            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-lg rounded-4 overflow-hidden border bg-white shadow-xs">
                        ...
                        <input type="text" class="form-control border-0 bg-transparent py-2 fs-6 shadow-none" id="direccion" name="direccion" pattern="^(Calle|Carrera|Avenida)\b.*" title="Debe iniciar con Calle, Carrera o Avenida" placeholder="Ej: Carrera 8 # 3-15" required>
                    </div>
                </div>
