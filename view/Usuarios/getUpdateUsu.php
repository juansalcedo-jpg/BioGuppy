...
<div class="container-fluid py-2">
  <div class="row justify-content-center">
    <div class="col-xl-9">
      ...
      <div class="mb-4">
        <h4 class="fw-semibold mb-1">Editar usuario</h4>
        <p class="text-muted small mb-0">Actualiza los datos del usuario seleccionado.</p>
      </div>

      <?php while($usu = $resultusu->fetch(PDO::FETCH_ASSOC)){ ?>
      <form action="<?php echo getUrl('Usuarios','Usuarios','postUpdateUsu')?>" method="post" novalidate>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="nombre" name="nombre"
                         value="<?php echo $usu['nombreusuario'] ?>" placeholder="Ingrese su nombre">
                </div>
              </div>
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="apellido" name="apellido"
                         value="<?php echo $usu['apellidousuario'] ?>" placeholder="Ingrese su apellido">
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="numeroDocumento" name="numeroDocumento"
                         value="<?php echo $usu['numerodocumento'] ?>" placeholder="Ingrese su número de documento">
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="correo" name="correo"
                         value="<?php echo $usu['correo'] ?>" placeholder="usuario@ejemplo.com">
                </div>
              </div>
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" class="form-control" id="celular" name="celular"
                         value="<?php echo $usu['usutelefono'] ?>" placeholder="Ingrese su celular">
                </div>
              </div>
            </div>
