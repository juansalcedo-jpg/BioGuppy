...
<div class="container-fluid px-0 py-2">
      ...
      <form action="<?php echo getUrl('ActividadesListZoo','ActividadesListZoo','postUpdate')?>" method="post" novalidate>
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            ...
            <div class="input-group">
                <span class="input-group-text bg-light border-0 rounded-start-3 text-muted"><i class="bi bi-calendar-date"></i></span>
                <input type="date" class="form-control bg-light border-0 rounded-end-3 py-2" id="fecha_actividad" name="fecha_actividad" value="<?php echo $actividad['fecha']; ?>" min="2026-09-10" max="<?php echo date('Y-m-d'); ?>" required>
            </div>
          </div>
        </div>
        ...
        <div class="p-3 bg-light rounded-4 mb-4 border-0">
            <h6 class="fw-bold text-dark small text-uppercase mb-3"><i class="bi bi-box2-heart text-primary me-1"></i> Parámetros de Alimentación</h6>
            <div class="row g-3">
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                <label for="tipo_alimentacion" class="form-label small fw-semibold text-secondary">Tipo de alimentación</label>
                <select class="form-select bg-white border-0 rounded-3 py-2" id="tipo_alimentacion" name="tipo_alimentacion">
        ...
        <div class="p-3 bg-light rounded-4 mb-4 border-0">
            <h6 class="fw-bold text-dark small text-uppercase mb-3"><i class="bi bi-heart-pulse text-primary me-1"></i> Control de Población</h6>
            <div class="row g-3">
              <div class="col-md-6">
                <label for="peces_nacidos" class="form-label small fw-semibold text-secondary">Peces nacidos</label>
                <input type="number" min="0" step="1" class="form-control bg-white border-0 rounded-3 py-2" id="peces_nacidos" name="peces_nacidos" value="<?php echo htmlspecialchars($actividad['pecesnacidos'] ?? 0); ?>">
              </div>
              <div class="col-md-6">
                <label for="peces_muertos" class="form-label small fw-semibold text-secondary">Peces muertos</label>
                <input type="number" min="0" step="1" class="form-control bg-white border-0 rounded-3 py-2" id="peces_muertos" name="peces_muertos" value="<?php echo htmlspecialchars($actividad['pecesmuertos'] ?? 0); ?>">
              </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <?php if ($esLimpieza): ?>
        <div class="p-3 bg-light rounded-4 mb-4 border-0">
            <h6 class="fw-bold text-dark small text-uppercase mb-3"><i class="bi bi-brush text-primary me-1"></i> Método de Limpieza</h6>
            <div class="row g-3">
              <div class="col-12">
        ...
        <div class="p-3 bg-light rounded-4 mb-4 border-0">
            <h6 class="fw-bold text-dark small text-uppercase mb-3"><i class="bi bi-activity text-primary me-1"></i> Parámetros Físico-Químicos</h6>
            <div class="row g-3">
              <div class="col-md-6">
                <label for="ph" class="form-label small fw-semibold text-secondary">pH *</label>
                <input type="number" step="0.1" class="form-control bg-white border-0 rounded-3 py-2" id="ph" name="ph" value="<?php echo htmlspecialchars($actividad['ph'] ?? ''); ?>" required>
              </div>
              <div class="col-md-6">
                <label for="temperatura" class="form-label small fw-semibold text-secondary">Temperatura (°C) *</label>
                <input type="number" step="0.1" class="form-control bg-white border-0 rounded-3 py-2" id="temperatura" name="temperatura" value="<?php echo htmlspecialchars($actividad['temperatura'] ?? ''); ?>" required>
              </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <?php if ($esLavado): ?>
        <div class="p-3 bg-light rounded-4 mb-4 border-0">
            <h6 class="fw-bold text-dark small text-uppercase mb-3"><i class="bi bi-droplet-half text-primary me-1"></i> Parámetro de Lavado</h6>
            <div class="row g-3">
              <div class="col-md-6">
                <label for="porcentaje_agua" class="form-label small fw-semibold text-secondary">Porcentaje de agua cambiada (%) *</label>
                <div class="input-group">
                  <input type="number" step="0.01" min="0" max="100" class="form-control bg-white border-0 rounded-start-3 py-2" id="porcentaje_agua" name="porcentaje_agua" value="<?php echo htmlspecialchars($actividad['porcentajeaguacambiada'] ?? ''); ?>" required>
        ...
        <div class="row mb-4">
          <div class="col-12">
            ...
            <textarea class="form-control bg-light border-0 rounded-3 p-3" id="observaciones" name="observaciones" rows="3" placeholder="Escribe notas u observaciones relevantes..."><?php echo htmlspecialchars($actividad['observaciones'] ?? ''); ?></textarea>
          </div>
        </div>

        <!-- Botones de Acción -->
        <div class="d-flex justify-content-end gap-2 pt-3 border-top">
          <button type="button" class="btn btn-light rounded-pill px-4 py-2 fw-semibold text-secondary border-0" data-bs-dismiss="modal">
              Cancelar
          </button>
