    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
            ...
            <div class="d-flex flex-wrap align-items-end justify-content-between mb-4 gap-2">
                <div>
                    <h4 class="fw-semibold mb-1">Actividades de Terreno</h4>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <span class="fw-semibold">
                        <i class="bi bi-map-fill me-2 text-primary"></i>Actividades de terreno registradas
                    </span>
                    <div class="input-group input-group-sm" style="max-width: 260px;">
                        <span class="input-group-text bg-light"><i class="bi bi-search"></i></span>
                        <input type="text" id="buscadorActTerre" class="form-control" placeholder="Buscar actividad..."
                            data-url="<?php echo getUrl('Catalogos', 'ActividadesTerre', 'filtro', false, 'ajax'); ?>">
                    </div>
                </div>

                <div class="table-responsive">
                    <table class="table table-striped align-middle mb-0" id="tablaActTerre">
                            ...
                            ?>
                                ...
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-5">
                                        ...
                                        No hay actividades de terreno registradas todavía.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
