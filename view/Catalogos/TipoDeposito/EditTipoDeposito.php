    ...
    <div class="container-fluid py-3">
        <div class="row justify-content-center">
            <div class="col-xl-8">
                ...
                <form action="<?php echo getUrl('Catalogos', 'TipoDeposito', 'postUpdateTipoDeposito') ?>" method="post" novalidate>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control" id="nombretipodeposito" name="nombretipodeposito"
                                        value="<?php echo htmlspecialchars($deposito['nombretipodeposito']); ?>">
                                </div>
                            </div>
