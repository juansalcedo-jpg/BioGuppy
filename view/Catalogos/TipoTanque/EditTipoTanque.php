...
<div id="tanqueFormEdicion">
    <div class="container-fluid px-1 py-1">
        ...
        <form action="<?php echo getUrl('Catalogos', 'TipoTanque', 'postUpdateTipoTanque') ?>" method="post" novalidate class="needs-validation">
            <input type="hidden" name="codtipotanque" value="<?php echo $tanque['codtipotanque']; ?>">

            <!-- Campo del nombre del tipo de tanque -->
            <div class="mb-3">
                <label for="nombretanque" class="form-label text-secondary fs-7 fw-bold text-uppercase tracking-wider mb-1">
                    Nombre del tipo de tanque <span class="text-danger">*</span>
                </label>
                <div class="input-group shadow-sm rounded-3 overflow-hidden border bg-white">
                    ...
                    <input type="text" class="form-control border-0 bg-white py-2 ps-2 shadow-none" id="nombretanque" name="nombretanque"
                           value="<?php echo htmlspecialchars($tanque['nombretipotanque']); ?>" placeholder="Ej: Concreto, Geomembrana..." required>
                </div>
                <div class="form-text text-muted small mt-1">Modifica el nombre con el que se identifica este tipo de tanque.</div>
            </div>
