<div id="tanqueFormRegistro">
    <div class="container-fluid px-1 py-1">
        ...
        <form action="<?php echo getUrl('Catalogos', 'TipoTanque', 'postCreateTipoTanque') ?>" method="post" novalidate class="needs-validation">
            ...
            <div class="mb-3">
                ...
                <div class="input-group shadow-sm rounded-3 overflow-hidden border bg-white">
                    ...
                    <input type="text" class="form-control border-0 bg-white py-2 ps-2 shadow-none" id="nombretanque" name="nombretanque" 
                           placeholder="Ej: Concreto, Geomembrana..." required>
                </div>
                <div class="form-text text-muted small mt-1">Ingresa el nombre con el que se identificará este tipo de tanque.</div>
            </div>
