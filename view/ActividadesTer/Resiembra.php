        ...
        <div class="col-12 col-xl-10">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    ...
                    <form id="formResiembra" action="<?php echo getUrl('ActividadesTer','ActividadesTer','postCreateResiembra'); ?>" method="POST" novalidate>
...
<script>
const formulario=document.getElementById("formResiembra");
