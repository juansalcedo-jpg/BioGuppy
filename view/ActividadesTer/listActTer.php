    ...
    <div class="col-xl-11">
      ...
      <div class="card border-0 shadow-sm">
          ...
          <form id="formFiltroHistorialTer" action="index.php" method="GET">
            ...
            <div class="row g-2 align-items-end">
              ...
              <div class="col-12 col-md-3">
                <label for="selectSitio" class="form-label small text-muted mb-1">Sitio</label>
                <select id="selectSitio" name="codsitio" class="form-select form-select-sm">
        ...
        <div class="table-responsive">
          <table class="table table-striped align-middle mb-0" id="tablaHistorialTer">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($act['sitio']); ?></td>
