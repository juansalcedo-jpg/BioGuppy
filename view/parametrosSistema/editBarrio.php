        ...
        <div class="row justify-content-center">
            <div class="col-xl-8">
                ...
                <div class="mb-4 text-center">
                    <h4 class="fw-semibold mb-1">Editar barrio</h4>
                    <p class="text-muted small mb-0">Corrige la comuna o el nombre del barrio.</p>
                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control" id="nombre_barrio" name="nombre_barrio"
                                           value="<?php echo htmlspecialchars($barrio['nombrebarrio']); ?>">
                                </div>
                            </div>
