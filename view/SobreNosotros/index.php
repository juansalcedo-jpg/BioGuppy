...
<div class="container-fluid py-2">
  <div class="row justify-content-center">
    <div class="col-xl-9">
      ...
      <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 text-white" style="background:linear-gradient(135deg,#004884,#3366CC);">
        <p class="mb-0 lh-lg">
      ...
      <div class="row g-3">
        <div class="col-md-4">
          <div class="card border-0 shadow-sm rounded-4 text-center p-4">
            <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2 text-white" style="width:48px;height:48px;background-color:#159EE8;font-size:1.3rem;">
              <i class="bi bi-calendar-check-fill"></i>
            </div>
            <div class="fs-2 fw-bold" style="color:#004884;">2026</div>
        ...
        <div class="col-md-4">
          <div class="card border-0 shadow-sm rounded-4 text-center p-4">
            ...
            <div class="fs-2 fw-bold" style="color:#004884;"><?php echo $zoocriaderosActivos; ?></div>
        ...
        <div class="col-md-4">
          <div class="card border-0 shadow-sm rounded-4 text-center p-4">
            ...
            <div class="fs-2 fw-bold" style="color:#004884;"><?php echo $sitiosActivos; ?></div>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="d-flex align-items-center gap-2 p-2">
              <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 text-white" style="width:40px;height:40px;background-color:#159EE8;font-size:.9rem;">
