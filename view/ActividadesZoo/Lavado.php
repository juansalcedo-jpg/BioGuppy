                ...
                <div class="card-body p-4">
                    <form action="<?php echo getUrl('ActividadesZoo', 'Lavado', 'postCreateLavado'); ?>" method="POST">
                        ...
                        <ul class="nav nav-tabs mb-4 border-bottom">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active fw-semibold text-primary border-0 border-bottom border-primary border-3" href="<?php echo getUrl('ActividadesZoo', 'Lavado', 'Lavado'); ?>">Lavado</a>
                            </li>
                        </ul>
