<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-12 col-xl-10">
            ...
            <h2 class="text-center fw-bold mb-4 text-dark">Actividad Parámetros Fisicoquímicos</h2>

            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    <form action="<?php echo getUrl('ActividadesZoo', 'Parametros', 'postCreateParametros'); ?>" method="POST">
