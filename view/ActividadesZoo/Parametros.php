<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-12 col-xl-10">
            ...
            <h2 class="text-center fw-bold mb-4 text-dark">Actividad Parámetros</h2>

            <!-- Tarjeta del Formulario -->
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    <form action="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'postCreateParametros'); ?>" method="POST">
                        ...
                        <!-- Titulo -->
                        <h5 class="fw-bold mb-4 text-dark">Registrar Parámetros</h5>

                        <!-- Campos Específicos: pH y Temperatura (°C) -->
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <label for="ph" class="form-label fw-semibold">pH</label>
                                <input type="number" step="0.1" class="form-control form-control-lg fs-6" id="ph" name="ph" placeholder="Ej. 7.2">
                            </div>

                            <div class="col-md-6">
                                <label for="temperatura" class="form-label fw-semibold">Temperatura (°C)</label>
                                <input type="number" step="0.1" class="form-control form-control-lg fs-6" id="temperatura" name="temperatura" placeholder="Ej. 24">
                            </div>
                        </div>
