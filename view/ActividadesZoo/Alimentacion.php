                ...
                <div class="card-body p-4">
                    <form action="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'postCreateAlimentacion'); ?>" method="POST">
                        ...
                        <ul class="nav nav-tabs mb-4 border-bottom">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'regNacidosMuertos'); ?>">Nacidos/Muertos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'regParametros'); ?>">Parámetros</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'regLimpieza'); ?>">Limpieza</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'regAjusteNivel'); ?>">Ajuste de nivel</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary" href="<?php echo getUrl('ActividadesZoo', 'ActividadesZoo', 'regLavado'); ?>">Lavado</a>
                            </li>
                        </ul>
