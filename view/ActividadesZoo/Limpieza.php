        ...
        <div class="col-12 col-xl-10">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    <form action="<?php echo getUrl('ActividadesZoo', 'Limpieza', 'postCreateLimpieza'); ?>" method="POST">
                        ...
                        <ul class="nav nav-tabs mb-4 border-bottom">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active fw-semibold text-primary border-0 border-bottom border-primary border-3" href="<?php echo getUrl('ActividadesZoo', 'Limpieza', 'Limpieza'); ?>">Limpieza</a>
                            </li>
                            <li class="nav-item">
