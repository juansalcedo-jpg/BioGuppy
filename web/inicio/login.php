...
<div class="modal fade modal-biopass" id="modalNuevaContrasena" tabindex="-1" aria-labelledby="modalNuevaContrasenaLabel" aria-hidden="true" data-url-validar-token="<?php echo '../' . getUrl('CambioContra', 'CambioContra', 'validar_codigo', false, 'ajax'); ?>">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
